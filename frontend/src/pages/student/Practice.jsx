...
const saveSubmittedProblems = (submissions) => {
  if (typeof window === "undefined") {
    return;
  }
...
const humanizeExecutionState = (executionState) => {
...
const createErrorExecutionState = (message, type = "validation_error") => ({
  summary: {
    passedCount: 0,
    totalCount: 1,
...
function Practice() {
  ...
  const [code, setCode] = useState(() => getCodeTemplate("javascript", CODING_PROBLEMS[0]));
  ...
  const getModuleProblems = () =>
    CODING_PROBLEMS.filter((problem) => problem.category === selectedModule);
  ...
  const handleLanguageChange = (newLanguage) => {
    ...
    setCode(getCodeTemplate(newLanguage, selectedProblem));
    setExecutionState(null);
    setIsDirtySinceRun(false);
  ...
  const runCode = async () => {
    ...
    try {
      const response = await api.post("/practice/execute", {
        code,
        language,
      ...
      <div className={`leetcode-container ${isDarkMode ? "dark-mode" : "light-mode"}`}>
            ...
            <div className="problem-list-drawer" onClick={(event) => event.stopPropagation()}>
              ...
              <div className="module-tabs">
                {MODULE_CATEGORIES.map((category) => {
                  const count = CODING_PROBLEMS.filter((problem) => problem.category === category).length;
              ...
              <div className="problems-grid">
                {getModuleProblems().map((problem, index) => (
                  <div
                    key={problem.id}
        ...
        <div className="leetcode-navbar">
          ...
          <div className="navbar-right">
            ...
            <button className="navbar-btn premium-badge" title="Judge0 powered execution">
              Judge0 Run
            </button>
            <button
              ...
              <div className="description-section">
                ...
                <div className="format-card">
                  <p className="description-text">
                    The editor now uses a GFG-style <code className="inline-code">solve(input)</code> template.
                    Judge0 runs your code against the sample inputs shown above.
                  </p>
                  <ul className="constraints-list">
              ...
              <div className="editor-toolbar">
                <div className="toolbar-left">
                  <div className="language-dropdown">
                    <button className="lang-btn" onClick={() => setShowLanguageMenu(!showLanguageMenu)}>
