/**
 * Legacy Judge0 utility.
 * The active practice flow runs through the backend `/practice/execute` route,
 * which keeps Judge0 credentials off the client. This helper is kept generic
 * for non-authenticated direct Judge0 instances.
 */

const JUDGE0_API_BASE =
  import.meta.env.VITE_JUDGE0_API_URL?.trim() || "https://ce.judge0.com";
